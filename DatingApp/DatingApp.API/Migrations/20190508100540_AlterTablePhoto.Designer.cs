...
namespace DatingApp.API.Migrations
{
    ...
    [Migration("20190508100540_AlterTablePhoto")]
    partial class AlterTablePhoto
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatingApp.API.Data.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DatingApp.API.Data.UserRole", b =>
                {
            ...
            modelBuilder.Entity("DatingApp.API.Data.UserRole", b =>
                {
                    b.HasOne("DatingApp.API.Data.Role", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("DatingApp.API.Data.Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
